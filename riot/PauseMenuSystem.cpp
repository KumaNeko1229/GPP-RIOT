...
namespace System {
	...
	void PauseMenuSystem::render(ECS::Manager* manager) {
		...
		Entity::createButtonEntity(this->manager, this->graphics, "Resume", GAME_WIDTH / 2, GAME_HEIGHT / 4);
		Entity::createButtonEntity(this->manager, this->graphics, "Back to Menu", GAME_WIDTH / 2, GAME_HEIGHT / 3);
	}
}